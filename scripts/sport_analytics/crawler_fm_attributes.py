...
print('start')
file_path = 'data/sport_analytics/raw/fm23_2.txt'  # Replace with the path to your .txt file containing HTML
...
pd.concat([player_list.set_index("Player ID"),main_attributes],axis=1).to_csv('datafm23.csv')
print('done')