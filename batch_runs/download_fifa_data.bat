...
py .\scripts\sport_analytics\run_crawler_fifa_players.py --fifa_versions 24
py .\scripts\sport_analytics\run_crawler_fifa_attributes.py --fifa_versions 24
py .\scripts\sport_analytics\merge_crawled_fifa_data.py --fifa_versions 24
